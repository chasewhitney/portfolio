...
const Header = () => {
  return (
    <div className="aboutme flex-column">
      <div className="aboutme__header">
        <span>HI, I'M </span>
        <span>CHASE WHITNEY</span>
      </div>
      <div className="aboutme__subhead">
        // A FULL-STACK DEVELOPER BASED IN EDEN PRAIRIE, MN
      </div>
      ...
      <div className="contact__list flex-row">
        <div className="contact__item tooltip">
          ...
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 448 512"
              className="nav__icon tooltipicon"
            >
              <path
                fill="currentColor"
        ...
        <div className="contact__item tooltip">
          <a
            href="https://drive.google.com/open?id=1Gi7Le2zyea1jGUsSzpGwjqNf92mIeDZZ"
        ...
        <div className="contact__item tooltip">
          <a
            href="mailto:chaseewhitney@gmail.com"
